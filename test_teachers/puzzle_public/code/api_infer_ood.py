...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=10, help='每个线程处理的批次大小（降低内存压力）')
...
def process_item(item, args):
    ...
    try:
        ...
        prompt += f'nPlease check carefully about each option. There must exist a right answer'
